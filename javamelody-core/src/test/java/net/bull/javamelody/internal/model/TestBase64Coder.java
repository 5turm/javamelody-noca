...
public class TestBase64Coder {
	...
	public void test2() throws IOException {
		...
		final Base64.Encoder sunEncoder = Base64.getEncoder();
		final Base64.Decoder sunDecoder = Base64.getDecoder();
		...
		for (int i = 0; i < 100; i++) {
			...
			final String e2 = sunEncoder.encodeToString(b0);
			assertEquals("test2", e2, e1);
			final byte[] b1 = Base64Coder.decode(e1);
			final byte[] b2 = sunDecoder.decode(e2);
